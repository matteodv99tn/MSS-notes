...
\newcommand{\rf}[1]{\mathfrak {R}_{#1}}
\newcommand{\rfw}{\mathfrak{R}^w}
\newcommand{\rfb}{\mathfrak{R}^b}
\newcommand{\transformationmatrix}[1]{\matrix{ \begin{array}{c c c | c} #1 \end{array}}}
\newcommand{\base}{\mathbf{e}}
\newcommand{\bb}{\base^b}
\newcommand{\bw}{\base^w}
\newcommand{\trace}[1]{\textrm{tr}\left\{#1\right\}}
\newcommand{\dvett}[1]{\dot{\vett #1}}
\newcommand{\ddvett}[1]{\ddot{\vett #1}}
\newcommand{\Po}{\mat P_\Omega}
\newcommand{\dPo}{\dot{\mat P}_\Omega}
